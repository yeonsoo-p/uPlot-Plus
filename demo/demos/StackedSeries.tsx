...
import { Chart, Scale, Series, Axis, Band, stackGroup } from '../../src';
import type { ChartData } from '../../src';
import type { BandConfig } from '../../src';
...
export default function StackedSeries() {
  ...
  return (
    <div>
      ...
      <Chart width={800} height={400} data={stackedData}>
        <Scale id="x" />
        <Scale id="y"  />
        <Axis scale="x" label="Sample" />
        <Axis scale="y" label="Value" />
        <Series group={0} index={0} yScale="y" stroke="#e74c3c" fill="rgba(231,76,60,0.4)" width={1} label="Series A" fillTo={0} />
        <Series group={0} index={1} yScale="y" stroke="#2ecc71" fill="rgba(46,204,113,0.4)" width={1} label="Series B" fillTo={0} />
        <Series group={0} index={2} yScale="y" stroke="#3498db" fill="rgba(52,152,219,0.4)" width={1} label="Series C" fillTo={0} />
